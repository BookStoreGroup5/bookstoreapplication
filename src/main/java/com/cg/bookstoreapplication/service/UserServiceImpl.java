...
import com.cg.bookstoreapplication.exception.InvalidUserException;
import com.cg.bookstoreapplication.repository.IUserRepository;
...
public class UserServiceImpl implements IUserService {
	...
	public User registerUser(User user) throws Exception {
		...
		if(user.getFirstName().equals("") || user.getLastName().equals("")) {
			throw new InvalidInputException("User name","First Name or Last Name is null");
		}
